...
static const double updateTime = 0.0001; //Update time in seconds for sensor readings
static double scaleMultiple = secsPerMin/(updateTime*tapeLines); //Multiplier to convert reads per update to RPM
...
static const double shootPosP = 0.7; //P Value for shooter aiming
static const double shootPosI = 0.0; //I Value for shooter aiming
static const double shootPosD = 0.0; //D Value for shooter aiming
static const double shootPosF = 0.0; //F Value for shooter aiming
...
static const double shooterRampTime = 1.5; //Ramp up time when shooting without RPM sensors
static const double shooterWaitTime = 0.25; //Wait time after shooting ball before retracting cylinder

//MultiTool constants
static const double shooterHalfPos = 0.715; //90 degrees shooter encoder position from ground, halfway point
